...
},{"./views/resultsView.js":"cSbZE","./views/searchView.js":"9OQAM","./views/recipeView.js":"l60JC","./model.js":"Y4A21","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./views/bookmarksView.js":"4Lqzq"}],"cSbZE":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"./View.js":"5cUXS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./previewView.js":"1FDQ6"}],"5cUXS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class View {
    _data;
    ...
    _generateMarkup() {
        return `
            <figure class="recipe__fig">
                <img class="recipe__img" src="${this._data.image}" alt="${this._data.title}" class="recipe__img">
            ...
            <div class="recipe__details">
                <div class="recipe__info">
                    ...
                    <span class="recipe__info-data recipe__info-data--minutes">${this._data.readyInMinutes}</span>
                ...
                <button class="btn--round">
                  ${this._data.bookmarked ? `<i class="fa-solid fa-bookmark btn--bookmark bookmarked"></i>` : `<i class="fa-regular fa-bookmark btn--bookmark not-bookmarked"></i>`}
            ...
            <div class="recipe__directions">
                ...
                <p class="recipe__directions-text">
                    ...
                    <span class="recipe__source">${this._data.sourceName}</span>. Please check out directions at their website.
                </p>
                <a href="${this._data.sourceUrl}" class="btn--small recipe_btn" target="_blank">
    ...
    _generateMarkupIngredient(ing) {
        return `
            <li class="recipe__ingredient">
                ...
                <div class="recipe__quantity">${ing.amount ? (0, _fractyDefault.default)(ing.amount) : ""}</div>
...
},{"./View.js":"5cUXS","fracty":"hJO4d","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hJO4d":[function(require,module,exports) {
...
const loadRecipe = async function(id) {
    try {
        const res = await fetch(`https://api.spoonacular.com/recipes/${id}/information?includeNutrition=false&apiKey=2eaf4c1b5b594a09a576c6008073c3a0`);
        const data = await res.json();
        // console.log(data);
...
},{"./View.js":"5cUXS","./previewView.js":"1FDQ6","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["d8XZh","aenu9"], "aenu9", "parcelRequire9c62")
